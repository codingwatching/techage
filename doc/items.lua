...
local items = {
	...
	concentrator_node = "techage:tube_concentrator_node25",
	...
	ta4_concentrator_node = "techage:ta4_tube_concentrator_node25",
...
for name, image in pairs(items) do
	...
	doclib.add_manual_image("techage", "ES", name, image)
end
